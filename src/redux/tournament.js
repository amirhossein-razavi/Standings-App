...
const Tournament = (state = { Tdata: [], TfinalData: [], fake: [], nextTeam: {}, nextTeam2: [], nextTeam3: [], nextTeam4: [], nextTeam5: [] }, action) => {
  switch (action.type) {
    ...
    case (ActionTypes.WINNER_TEAM): {
      ...
      } if (state.fake.index === 4 || state.fake.index === 5) {
        return {
          ...state,
